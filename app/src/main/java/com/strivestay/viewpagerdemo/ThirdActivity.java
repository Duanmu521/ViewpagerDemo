...
import com.strivestay.viewpagerdemo.holder.LocalImageHolderView;
import com.strivestay.viewpagerdemo.pagetransformer.DepthPageTransformer;
 ...
 * @date 2018/2/23
 */
public class ThirdActivity extends BaseActivity implements AdapterView.OnItemClickListener, ViewPager.OnPageChangeListener, OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setToolbar("轮播图", FourthActivity.class);
        initViews();
        init();
    }
